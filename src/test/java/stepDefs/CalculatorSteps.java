...
public class CalculatorSteps {
	...
	public void sub_and(int num1, int num2) {
	    // Write code here that turns the phrase above into concrete actions
	...
	public void i_order_below_items_and_quantity(io.cucumber.datatable.DataTable dataTable) {
		...
		//	result = result + (((Integer.parseInt(dataTable.cell(i, 1))) * (Integer.parseInt(dataTable.cell(i, 2)))));
			...
			// Integer.parseInt(dataTable.cell(i, 1)) -- To fetch quantity
			// Integer.parseInt(dataTable.cell(i, 2)) -- To fetch price
			// result = result + (quantity * price) -- Total Bill
		}
	}
